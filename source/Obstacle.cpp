...
bool Obstacle_IntersectsSegment(Obstacle* obstacle, Vector2D segmentStart, Vector2D segmentEnd, 
	Vector2D* intersectionPoint, Vector2D* normalVector)
{
	...
	bool result = Vector2DUtils::SegmentSegmentIntersection(obstacle->position, obstacleEndSegment, 
		segmentStart, segmentEnd, false, intersectionPoint);
