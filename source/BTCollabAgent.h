...
class BTCollabAgent : public BTAgent
{
public: 
	// Constructor
	BTCollabAgent(int x, int y, int width, int height, Texture* questionTexture, int agentID) :
